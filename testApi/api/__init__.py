...
if inv == 'live':
    ...
    app.config['REPORT_URL'] = "http://stepupforward.com/api/report/download/"
    app.config['DOC_URL'] = "http://stepupforward.com/api/"
elif inv == 'test':
...
app.config['BASE_URL'] = "https://pmi.redtons.com/assets/default/"
