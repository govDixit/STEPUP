...
from api.lib.helper import getData,getId,getCurrentUser,getRow
...
class Stock(Resource):
    ...
    def post(self,user_id):
        try:
            ...
            result = mongo.db.products.find({'status':1},{'_id':1})
            #for row in result:
            ...
            if r:
                ...
                newvalues = {"$set": {"stock" : data,"step1_verify":0,"step2_verify":0,"step3_verify":0,"step1_data":None,"step2_data":None,"step3_data":None}}
